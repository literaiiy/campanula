    ...
    <>
      ...
      <section className='main'>
        <div className='content'>
          ...
          <p>The pomodoro method, invented by Italian author Francesco Cirillio in the 1980s, is a time management method that aims to separate a sizable task into more easy-to-digest intervals. Each interval, called a pomodoro, is comprised of a work session and a break session— generally 25 minutes of work and 5 minutes of rest. After a set amount of pomodoros (generally 4), a long break commences (generally 15 minutes long).</p>
