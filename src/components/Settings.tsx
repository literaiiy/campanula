...
export default function Settings() {
  return (
    <ul className="settings-list">
      <SettingsOption type="hms" id="work-time" label="Work length" ph="25 min"/>
      <SettingsOption type="hms" id="break-time" label="Break length" ph="5 min"/>
      <SettingsOption type="hms" id="long-break-time" label="Long break length" ph="15 min"/>
